...
<div class="container">
    ...
    <h1 class="my-4">{{ __('page.discord.index.name') }}</h1>

    <section id="discord">

        {{ Form::open(['action' => ['DiscordController@push'], 'files' => true]) }}
        <div class="form-row">
           
            <div class="form-group col-md-12">
                {{ Form::label('discord_text', 'Текс') }}
                {{ Form::textarea('discord_text', null, ['class' => 'form-control']) }}
            </div>

            <div class="form-group col-md-12">
                {{ Form::submit('Отправить', ['class' => 'btn btn-primary float-right col-md-2']) }}
            </div>
...
<script>
    $(document).ready(function(){
        ...
        tinymce.init({
            selector: 'textarea#discord_text',
            language: 'ru', 
            menubar: false,          
            statusbar: false,
            plugins: '', 
